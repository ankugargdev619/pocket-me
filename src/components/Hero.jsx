         ...
         <motion.div 
            ...
            >
                ...
                <div className="flex flex-col md:flex-row gap-10 items-center">
                    <a href="#">
                        <img className="w-80" src="../src/assets/images/google-play.png" alt="" />
                    </a>
                    {/*
                    <a href="#">
                        <img className="w-80" src="../src/assets/images/app-store.png" alt="" />
                    </a>*/}
                </div>
            </motion.div>
            ...
            >
                <img className="max-w-xs self-center" src="../src/assets/images/slider-dec.png" alt="slider" />
            </motion.div>
        </motion.div>
    )
}
